 ...
 */
export const getNetSongListDetail = (id: string) => {
 ...
 * 接口地址 : /search
 */
export const getNetSearchResult = (keyword: string) => {
 ...
 * 接口地址 : /artists
 */
export const getNetSingerInfo = (id: string) => {
 ...
 * 接口地址 : /song/url
 */
export const getNetSongDetail = (ids: string) => {
 ...
 * 接口地址 : /song/detail
 */
export const getNetSongDetailData = (ids: string) => {
 ...
 * 接口地址 : /lyric
 */
export const getNetSongLyric = (id: string) => {

 ...
 * 接口地址 : /getMusicVKey
 */
export const getTencentSongDetail = (id: string) => {
 ...
 * 接口地址: /getSearchByKey
 */
export const getTencentSearchResult = (keyword: string) => {
 ...
 * 接口地址: /getSingerAlbum
 */
export const getTencentSingerInfo = (id: string) => {
 ...
 * 接口地址 : /getLyric
 */
export const getTencentSongLyric = (id: string) => {

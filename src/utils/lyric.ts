...
export default class netLyric {
    constructor(lrc: any, hanlder = noop) {
        this.lrc = lrc
        this.tags = {}
        this.lines = []
    ...
    _initLines() {
        ...
        this.lines.sort((a: { time: number }, b: { time: number }) => {
    ...
    play(startTime = 0, skipLast: boolean | undefined) {
